<div class="page-left">
	<article class="form">
		<header>
			<h1 class="large">Event aanpassen</h1>
		</header>
		<div class="form">
		<form method="post" action="<?php echo url_for('edit-public-event', array('id' => $event->id)); ?>" id="public_event" name="public_event">
			<div class="row">
				<div class="label">
			...
			<div class="row">
				<div class="label">
					<label for="event_end">Eindtijd ( Uren/minuten vanaf start tijd )</label>
				</div>
				<?php echo $form['end'] ?>
			</div>
			<div class="clear"></div>
