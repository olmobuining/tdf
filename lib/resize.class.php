...
class resizeImage {
	var $image;
	var $image_type;
	var $prefixFolder = '/home/id514/domains/guild-tdf.nl/public_html/web/uploads/images/';
	...
	protected function resizeToMaxSize($filename, $saveName, $filesize='large') {
		...
		$this->save($this->prefixFolder.$saveName.DIRECTORY_SEPARATOR.$folder.DIRECTORY_SEPARATOR.$filename);
		return $saveName;
	}
