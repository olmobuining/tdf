 ...
 * @method ImageType           setId()             Sets the current record's "id" value
 * @method ImageType           setName()           Sets the current record's "name" value
 * @method ImageType           setImages()         Sets the current record's "Images" collection
 * @method ImageType           setImageImageType() Sets the current record's "ImageImageType" collection
 * 
 * @package    tdf
 * @subpackage model
