 ...
 *
 * @method ImageType getObject() Returns the current form's model object
 *
 * @package    tdf
 * @subpackage form
 ...
 */
abstract class BaseImageTypeForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->validatorSchema->setPostValidator(
      new sfValidatorAnd(array(
        new sfValidatorDoctrineUnique(array('model' => 'ImageType', 'column' => array('id'))),
        new sfValidatorDoctrineUnique(array('model' => 'ImageType', 'column' => array('slug'))),
      ))
    );
