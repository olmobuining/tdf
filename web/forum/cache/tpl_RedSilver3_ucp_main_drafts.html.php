...
<?php } if (! $this->_rootref['S_EDIT_DRAFT']) {  if ($this->_rootref['S_DRAFT_ROWS']) {  ?>
	...
	<tr> 
		...
		<td class="row2">
			...
			<tr>
				<td colspan="9"><textarea class="post" name="message" rows="10" cols="70" onselect="storeCaret(this);" onclick="storeCaret(this);" onkeyup="storeCaret(this);" onfocus="initInsertions();"><?php echo (isset($this->_rootref['DRAFT_MESSAGE'])) ? $this->_rootref['DRAFT_MESSAGE'] : ''; ?></textarea></td>
			</tr>
			<tr>
				<td colspan="9">
